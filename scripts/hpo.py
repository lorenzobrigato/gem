...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Tunes batch size, learning rate, and weight decay using asynchronous successive halving.',
    ...
    group.add_argument('--checkpoint-at-end', type=bool, default=False,
                       help='Whether to save checkpoints at the end of the experiments. Needed for eventual restoring/rerun of trials. Default to False.')
