...
|:------------------|--------:|-----------:|---------:|-------:|:---------------|:--------------|:---------------|
| [ciFAIR-10][1] <sup>*</sup> |      10 |         50 |      500 | 10,000 | Natural Images | RGB (32x32)   | ```cifair10``` |
| [CUB][2]          |     200 |         30 |    5,994 |  5,794 | Fine-Grained   | RGB           | ```cub```      |
| [ISIC 2018][3]  <sup>*</sup> |       7 |         80 |      560 |  1,944 | Medical        | RGB           | ```isic2018``` |
| [EuroSAT][4]  <sup>*</sup>   |      10 |         50 |      500 | 19,500 | Remote Sensing | Multispectral | ```eurosat```  |
| [CLaMM][5]  <sup>*</sup>     |      12 |         50 |      600 |  2,000 | Handwriting    | Grayscale     | ```clamm```    |
